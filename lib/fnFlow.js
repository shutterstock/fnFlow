...
module.exports = {
  flow: function flow(tasks, data, callback){
    ...
    if(tasks) us.extend(newTasks, us.object(Object.keys(tasks), us.map(Object.keys(tasks), function(key){ console.log('completed task', key); return flowCall(tasks[key], key, tasks, data); } )));
