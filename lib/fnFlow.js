...
Flow.prototype.addFn = function addTask(name, fn, args) {
  return this._add(new SyncTask(name, fn, Array.prototype.slice.call(arguments, 2)));
}
...
Flow.prototype._createPlan = function _createPlan(data) {
  ...
  if(!self.tasks || !Object.keys(self.tasks).length) throw Error("No tasks given for Flow.");
